...
#
get_filename_component(filename "D:/dev/game_engine_study/build/x64-Debug/_deps/sfml-tmp/3.0.0.zip" ABSOLUTE)
get_filename_component(directory "D:/dev/game_engine_study/build/x64-Debug/_deps/sfml-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-sfml${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-sfml${i}")
