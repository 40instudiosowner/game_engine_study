...
#
get_filename_component(filename "D:/dev/game_engine_study/build/x64-Debug/_deps/imgui-sfml-tmp/v3.0.zip" ABSOLUTE)
get_filename_component(directory "D:/dev/game_engine_study/build/x64-Debug/_deps/imgui-sfml-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-imgui-sfml${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-imgui-sfml${i}")
